...
const tabs = [
  { to: '/app', icon: CalendarDays, label: 'Planner' },
  { to: '/app/recipes', icon: BookOpen, label: 'Recipes' },
  { to: '/app/grocery-list', icon: ShoppingCart, label: 'Grocery' },
  { to: '/app/food-log', icon: Utensils, label: 'Food Log' },
