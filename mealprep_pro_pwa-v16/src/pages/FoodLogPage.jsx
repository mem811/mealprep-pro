            ...
            <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <label className="text-xs font-semibold text-gray-600">Servings
                <input type="number" className="mt-1 w-full px-3 py-2 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-emerald-200"
                  ...
                  onChange={(e) => setManualFood((p) => ({ ...p, servings: e.target.value }))}
                  placeholder="1" />
              </label>
      ...
      {editing && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative w-[92%] max-w-lg rounded-2xl bg-white shadow-xl border border-gray-100 p-4">
            ...
            <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-3">
              <label className="text-xs font-semibold text-gray-600">Meal type
                <input className="mt-1 w-full px-3 py-2 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-emerald-200" value={editing.meal_type} onChange={(ev) => setEditing((p) => ({ ...p, meal_type: ev.target.value }))} />
              </label>
              <label className="text-xs font-semibold text-gray-600">Name
                <input className="mt-1 w-full px-3 py-2 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-emerald-200" value={editing.name} onChange={(ev) => setEditing((p) => ({ ...p, name: ev.target.value }))} />
              </label>
              <label className="text-xs font-semibold text-gray-600">Calories
                <input type="number" className="mt-1 w-full px-3 py-2 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-emerald-200" value={editing.calories} onChange={(ev) => setEditing((p) => ({ ...p, calories: ev.target.value }))} />
              </label>
              <label className="text-xs font-semibold text-gray-600">Servings
                <input type="number" className="mt-1 w-full px-3 py-2 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-emerald-200"
              ...
              <label className="text-xs font-semibold text-gray-600">Protein (g)
                <input type="number" className="mt-1 w-full px-3 py-2 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-emerald-200" value={editing.protein} onChange={(ev) => setEditing((p) => ({ ...p, protein: ev.target.value }))} />
              </label>
              <label className="text-xs font-semibold text-gray-600">Carbs (g)
                <input type="number" className="mt-1 w-full px-3 py-2 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-emerald-200" value={editing.carbs} onChange={(ev) => setEditing((p) => ({ ...p, carbs: ev.target.value }))} />
              </label>
              <label className="text-xs font-semibold text-gray-600">Fat (g)
                <input type="number" className="mt-1 w-full px-3 py-2 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-emerald-200" value={editing.fat} onChange={(ev) => setEditing((p) => ({ ...p, fat: ev.target.value }))} />
              </label>
              <label className="text-xs font-semibold text-gray-600 sm:col-span-2">Notes
                <textarea className="mt-1 w-full px-3 py-2 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-emerald-200 min-h-[90px]" value={editing.notes} onChange={(ev) => setEditing((p) => ({ ...p, notes: ev.target.value }))} />
              </label>
            </div>
            <div className="mt-4 flex items-center justify-end gap-2">
